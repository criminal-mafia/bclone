...
jalan("\033[1;96m---> \033[1;32mFacebook Page : facebook.com/TheMehtan")
jalan("\033[1;96m---> \033[1;32mBangladeshi BOTOL")
jalan("\033[1;96m---> \033[1;32mPROUD TO BE A MUSLIM PROUD TO BE A BOTOL")

jalan('\033[1;96m---> \033[1;32m TEAM VVIRUS \033[1;31m[ TVV ]')
...
def menu():
	...
	print "\033[1;32m<-----\033[1;93mMEHEDI㋡ UPGRADE BOTOL㋡\033[1;32m----->"
	print "\033[1;97m-------------------------------"
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;32m<-----\033[1;93mMEHEDI • YOUR UNKNOWN ASS KICKER BROTHER OF YOUR UNKNOWN SISTER ㋡ BOTOL•MEHEDI㋡\033[1;32m----->"
	...
	print "\033[1;32m<-----\033[1;93mMEHEDI㋡ BOTOL•MEHEDI㋡\033[1;32m----->"
	jalan(' \033[1;97m•••••••••••\033[1;93mCloning Start..\033[1;97m•••••••••• ')
	jalan(' \033[1;32m<-----\033[1;93mMEHEDI㋡ BOTOL•MEHEDI㋡\033[1;32m----->')
	jalan(' \033[1;97m-----------------------------------')
	...
	p = ThreadPool(50)
	p.map(main, id)
	print "\033[1;32m<-----\033[1;93mHack The World, Because Nothing Is Personal㋡ BOTOL MEHEDI ㋡\033[1;32m----->"
	print "  \033[1;93m<-----Developed By Mehedi Hasan Ariyan----->" #Dev:Botol_Mehedi
	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 bclone.py)↩\033[1;97m....'
